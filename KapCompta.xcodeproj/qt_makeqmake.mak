...
QMAKE    = /usr/bin/qmake
KapCompta.xcodeproj/project.pbxproj: KapCompta.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o KapCompta.xcodeproj/project.pbxproj KapCompta.pro
